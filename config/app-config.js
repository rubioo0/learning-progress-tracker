...
module.exports = {
    ...
    AI_GENERATE_MAX_OUTPUT_TOKENS: parseNumber(process.env.AI_GENERATE_MAX_OUTPUT_TOKENS, 12288),
    AI_GENERATE_REDUCED_OUTPUT_TOKENS: parseNumber(process.env.AI_GENERATE_REDUCED_OUTPUT_TOKENS, 8192),
    AI_GENERATE_EMERGENCY_OUTPUT_TOKENS: parseNumber(process.env.AI_GENERATE_EMERGENCY_OUTPUT_TOKENS, 6144),
    AI_EXPLAIN_MAX_OUTPUT_TOKENS: parseNumber(process.env.AI_EXPLAIN_MAX_OUTPUT_TOKENS, 2048),
    AI_RETRY: {
        maxRetriesPerModel: parseNumber(process.env.AI_RETRY_MAX_RETRIES_PER_MODEL, 4),
